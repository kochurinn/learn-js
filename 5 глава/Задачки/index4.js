...
// Условие: Напиши функцию isBalanced(str, stack = []), которая проверяет, правильно ли расставлены скобки (), [], {} в строке.

// Решение через цикл

const isBalanced = (str, stack = []) => {
  ...
  for (let char of str) {
    if (openChars.includes(char)) {
      ...
      let lastOpenChar = stack.pop();
      if (openChars.indexOf(lastOpenChar) !== closeChars.indexOf(char)) {
        return false;
      }
    }
  }
